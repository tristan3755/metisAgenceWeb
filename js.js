...
let divTechnos7 = document.getElementById('divTechno7')

let observerTechnologies7 = new IntersectionObserver((entries, observer) => {

  entries.forEach((entry) => {
    if (entry.intersectionRatio >= 0.5) {
      divTechnos7.style.opacity = "1"
      observer.disconnect()
    }
  })
}, {
...
let targetTechnosDiv7 = divTechnos7
observerTechnologies7.observe(targetTechnosDiv7);



let divTechnos8 = document.getElementById('divTechno8')

let observerTechnologies8 = new IntersectionObserver((entries, observer) => {

  entries.forEach((entry) => {
    if (entry.intersectionRatio >= 0.5) {
      divTechnos8.style.opacity = "1"
      observer.disconnect()
    }
  })
}, {
...
let targetTechnosDiv8 = divTechnos8
observerTechnologies8.observe(targetTechnosDiv8);





let divTechnos9 = document.getElementById('divTechno9')

let observerTechnologies9 = new IntersectionObserver((entries, observer) => {

  entries.forEach((entry) => {
    if (entry.intersectionRatio >= 0.5) {
      divTechnos9.style.opacity = "1"
      observer.disconnect()
    }
  })
}, {
...
let targetTechnosDiv9 = divTechnos9
observerTechnologies9.observe(targetTechnosDiv9);
